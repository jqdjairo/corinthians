...
//não precisa do onclick
import kotlinx.android.synthetic.main.activity_upload_estudante.*
...
class Upload : AppCompatActivity(){
    ...
    private val CLIENT_ID = "63c31aad455863b"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_upload_estudante)
    ...
    private fun uploadImageToImgur(image: Bitmap) {
        ...
        getBase64Image(image, complete = { base64Image ->
            GlobalScope.launch(Dispatchers.Default) {
                ...
                val myIntent = Intent(this@Upload, DetailsActivity::class.java)
